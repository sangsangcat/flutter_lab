...
class ChildState extends State<ChildWidget> with WidgetsBindingObserver{
  ChildState(){
    print('ChildState constructor...${identityHashCode(this)}');
  }
  @override
  void initState() {
    super.initState();
  ...
  void dispose() {
    ...
    print('ChildState dispose...${identityHashCode(this)}');
  }
...
//key 를 이용....
// I/flutter ( 2930): ChildWidget constructor... Label A
// I/flutter ( 2930): ChildState didUpdateWidget... old=Label B, new=Label A
// I/flutter ( 2930): ChildState build...
